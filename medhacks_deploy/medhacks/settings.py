...
# ]
#
AWS_ACCESS_KEY_ID = 'AKIAQ3DBSO62W4PDYBH4'
AWS_SECRET_ACCESS_KEY = 'l5SJX719G7s4xUJXORT9SLXsZnHP6sVJErLjOl3M'
# AWS_STORAGE_BUCKET_NAME = 'medhacks-2019-resumes'
#
# # sensitive data will be replaced with environment variables when page is public
# AWS_S3_CUSTOM_DOMAIN = 'apply.medhacks.io' % AWS_STORAGE_BUCKET_NAME
